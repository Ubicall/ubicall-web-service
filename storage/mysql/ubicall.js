...
function getEmail(licence_key) {
    return when.promise(function(resolve, reject) {
        return $email_destination.findAll({
            where: {
...
function getEmail2(email_id) {
    return when.promise(function(resolve, reject) {
        return $email_destination.findOne({
            where: {
                id: email_id
            }
        }).then(function(email) {
...
function insertEmail(subject, destination, email) {
    return when.promise(function(resolve, reject) {
        $send_email.create({
...
=======
    scheduleDemoCall: scheduleDemoCall
>>>>>>> 5a22e087068e7055dfb9fee6ad149cfd0b23e419
    getAdminQueues,
    feedback: feedback,
    getAdmin: getAdmin,
    updateIVR: updateIVR,
